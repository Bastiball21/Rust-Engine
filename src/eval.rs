...
#[rustfmt::skip]
pub static MG_PAWN_TABLE: [EvalValue; 64] = a![
    0,   0,   0,   0,   0,   0,   0,   0,  // Rank 8 (Promotion)
    50,  50,  50,  50,  50,  50,  50,  50, // Rank 7
    10,  10,  20,  30,  30,  20,  10,  10, // Rank 6
     5,   5,  10,  25,  25,  10,   5,   5, // Rank 5
     0,   0,  20,  50,  50,  20,   0,   0, // Rank 4 (Center Boost: d4/e4)
     5,   5,  10,  20,  20,  10,   5,   5, // Rank 3 (Solid but less active)
     0,   0,   0, -10, -10,   0,   0,   0, // Rank 2 (Start Rank - encourage moving)
